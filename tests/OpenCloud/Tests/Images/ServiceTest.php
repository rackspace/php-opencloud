...
namespace OpenCloud\Tests\Images;
...
class ServiceTest extends OpenCloudTestCase
{
    ...
    public function test_Image_List()
    {
        ...
        $this->assertInstanceOf('OpenCloud\Images\Resource\Image', $images->getElement(0));
    }

    public function test_Get_Image()
    {
        $this->assertInstanceOf('OpenCloud\Images\Resource\Image', $this->service->getImage('foo'));
    }

    public function test_Images_Schema()
    {
        $this->assertInstanceOf('OpenCloud\Images\Resource\Schema\Schema', $this->service->getImagesSchema());
    }

    public function test_Image_Schema()
    {
        $this->assertInstanceOf('OpenCloud\Images\Resource\Schema\Schema', $this->service->getImageSchema());
    }

    public function test_Members_Schema()
    {
        $this->assertInstanceOf('OpenCloud\Images\Resource\Schema\Schema', $this->service->getMembersSchema());
    }

    public function test_Member_Schema()
    {
        $this->assertInstanceOf('OpenCloud\Images\Resource\Schema\Schema', $this->service->getMemberSchema());
    }
}