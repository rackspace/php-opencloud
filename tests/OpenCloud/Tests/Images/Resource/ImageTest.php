...
EOT;
        ...
        $this->assertInstanceOf('OpenCloud\Images\Resource\Member', $members->getElement(0));
    }
    ...
    public function test_Get_Member()
    {
        ...
        $this->assertInstanceOf('OpenCloud\Images\Resource\Member', $this->image->getMember('foo'));
    }
