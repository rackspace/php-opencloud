...
return array(
	...
	'monitoring_zones/{w}/traceroute' => 'Zone/list',

	'entities/{w}/alarms' => 'Alarm/post',
	'entities/{w}/test-alarm' => 'Alarm/test_alarm_post',
	'entities/entityId/alarms/alarmId' => 'Alarm/put',
	...
	'notifications/{w}/test' => 'Notification/test_post',
	'test-notification' => 'Notification/test_existing_post',
