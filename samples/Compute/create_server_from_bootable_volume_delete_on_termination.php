...
// 6. Create server from bootable volume, setting the volume to be
// deleted when the server is terminated (deleted). If you do not know what
// imageId or flavorId to use, please run the list_flavors.php and
